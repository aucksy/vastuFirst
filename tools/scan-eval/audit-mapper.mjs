...
put('BEDROOM', 'BEDROOM', 'BED ROOM', 'BED', 'SER ROOM', 'SERVANT ROOM', 'SERVANT', 'MAID ROOM',
  ...
  // The client's Tower E&F sheet prints `MAIDS RM.` — the plural was the whole gap (RoomLabels.kt).
...
put('TOILET', 'TOILET', 'WC', 'WATER CLOSET', 'POWDER ROOM', 'PWD', 'ATT TOILET', 'ATTACHED TOILET', 'COMMON TOILET', 'WASHROOM', 'WASH ROOM', 'TOIL');
